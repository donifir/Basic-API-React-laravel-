...
export default function Create() {
  ...
  async function getBarang() {
    try {
      ...
      console.log(response.data.data.id_suplier, "this barang");
      ...
      setSuplier(response.data.data.nama_suplier);
        ...
        <div className="card-body">
          <form onSubmit={createBarang}>
            ...
            {/* <div className="mb-3">
              ...
              >
                <option selected value={suplierId}>
                  {suplier}
                </option>
